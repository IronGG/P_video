<div class="flex items-center justify-center my-12">
    ...
    <div class="relative inline-block w-8/12 mr-5" x-data="{ open : false }">
        ...
        <input @click.away="{ open = false; @this.resetIndex(); }" @click="{ open = true }" class="w-full px-8 py-4 text-gray-600 text-gray-700 bg-gray-300 border-2 border-gray-500 rounded-full focus:outline-none" placeholder="Rechercher une vidéo..." wire:model="query" wire:keydown.arrow-down.prevent="incrementIndex" wire:keydown.arrow-up.prevent="decrementIndex" wire:keydown.escape="resetIndex" wire:keydown.enter="showJob">
